...
const TimetableLocators = {
  ...
  nthDayHigherFuncSkills: (n: number) => `.timetable-day-blocks:nth-of-type(${n}) .timetable-desc:has-text("HIGHER FUNC. SKILLS")`,
  nthDayCleaningActivities: (n: number) => `.timetable-day-blocks:nth-of-type(${n}) .timetable-desc:has-text("ED CLEANING ORD.")`,
